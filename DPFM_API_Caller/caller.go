...
import (
	"context"
	dpfm_api_input_reader "data-platform-api-message-deletes-rmq-kube/DPFM_API_Input_Reader"
	dpfm_api_output_formatter "data-platform-api-message-deletes-rmq-kube/DPFM_API_Output_Formatter"
	"data-platform-api-message-deletes-rmq-kube/config"
...
func (c *DPFMAPICaller) headerDelete(
	...
	res, err := c.rmq.SessionKeepRequest(nil, c.conf.RMQ.QueueToSQL()[0], map[string]interface{}{"message": header, "function": "MessageHeader", "runtime_session_id": sessionID})
	if err != nil {
